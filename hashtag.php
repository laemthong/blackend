        ...
        while($row = $result->fetch_assoc()) {
            echo "<tr>
                ...
                <td>
                    ...
                    <a class='btn btn-delete' href='hashtag.php?delete=".htmlspecialchars($row["hashtag_id"])."' onclick='return confirmDelete()'>ลบ</a>
                </td></tr>";
...
function confirmAdd() {
   ...
   // ฟังก์ชันสำหรับกรอกข้อมูลลงในฟอร์มแก้ไข
   function editHashtag(hashtag_id, hashtag_message) {
        ...
        // เรียกฟังก์ชันเพื่อยืนยันการแก้ไข
        if (confirmEdit()) {
            alert("กรุณาแก้ไขข้อมูลในฟอร์มและกดบันทึก");
        }
    }

    // Pre-fill the hashtag message with "#" if empty
